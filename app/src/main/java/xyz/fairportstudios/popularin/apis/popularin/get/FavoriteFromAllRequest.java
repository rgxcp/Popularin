...
public class FavoriteFromAllRequest {
    ...
    public FavoriteFromAllRequest(Context context, int filmID) {
        mContext = context;
        mFilmID = filmID;
    }
    ...
    public void sendRequest(int page, final Callback callback) {
        String requestURL = PopularinAPI.FILM + mFilmID + "/favorites/from/all?page=" + page;
        ...
        Volley.newRequestQueue(mContext).add(favoriteFromAll);
    }
}
