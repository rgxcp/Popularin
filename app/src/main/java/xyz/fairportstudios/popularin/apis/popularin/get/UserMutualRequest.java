...
public class UserMutualRequest {
    ...
    public UserMutualRequest(Context context, int userID) {
        mContext = context;
        mUserID = userID;
    }
    ...
    public void sendRequest(int page, final Callback callback) {
        String requestURL = PopularinAPI.USER + mUserID + "/mutuals?page=" + page;
        ...
        Volley.newRequestQueue(mContext).add(userMutual);
    }
}
