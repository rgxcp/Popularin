...
public class FilmReviewFromFollowingRequest {
    private Context mContext;
    private int mFilmID;

    public FilmReviewFromFollowingRequest(Context context, int filmID) {
        mContext = context;
        mFilmID = filmID;
    }
    ...
    public void sendRequest(int page, final Callback callback) {
        String requestURL = PopularinAPI.FILM + mFilmID + "/reviews/from/following?page=" + page;

        JsonObjectRequest filmReviewFromFollowing = new JsonObjectRequest(Request.Method.GET, requestURL, null, new Response.Listener<JSONObject>() {
            @Override
        ...
        Volley.newRequestQueue(mContext).add(filmReviewFromFollowing);
    }
}
