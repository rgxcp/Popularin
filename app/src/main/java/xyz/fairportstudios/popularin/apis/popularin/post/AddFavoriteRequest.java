...
public class AddFavoriteRequest {
    ...
    public AddFavoriteRequest(Context context, Integer filmID) {
    ...
    public void sendRequest(final Callback callback) {
        String requestURL = PopularinAPI.FILM + filmID + "/favorite";
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    if (status == 202) {
                        ...
                        callback.onError(context.getString(R.string.add_favorite_error));
                    }
