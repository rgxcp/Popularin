...
public class AddFavoriteRequest {
    ...
    public AddFavoriteRequest(Context context, int filmID) {
        mContext = context;
        mFilmID = filmID;
    }
    ...
    public void sendRequest(final Callback callback) {
        String requestURL = PopularinAPI.FILM + mFilmID + "/favorite";
        ...
        Volley.newRequestQueue(mContext).add(addFavorite);
    }
}
