...
public class LikeFromAll {
    private String id;
    private Context context;
    private List<User> userList;
    private RecyclerView recyclerView;

    public LikeFromAll(String id, Context context, List<User> userList, RecyclerView recyclerView) {
        this.id = id;
    ...
    public void sendRequest(final JSONCallback callback) {
        String requestURL = PopularinAPI.REVIEW + "/" + id + "/likes/from/all";
