...
public class FollowUserRequest {
    ...
    public FollowUserRequest(Context context, int userID) {
        mContext = context;
        mUserID = userID;
    }
    ...
    public void sendRequest(final Callback callback) {
        String requestURL = PopularinAPI.USER + mUserID + "/follow";

        JsonObjectRequest followUser = new JsonObjectRequest(Request.Method.POST, requestURL, null, new Response.Listener<JSONObject>() {
            @Override
        ...
        Volley.newRequestQueue(mContext).add(followUser);
    }
}
