...
public class UserFollowingRequest {
    ...
    public UserFollowingRequest(Context context, int userID) {
        mContext = context;
        mUserID = userID;
    }
    ...
    public void sendRequest(int page, final Callback callback) {
        String requestURL = PopularinAPI.USER + mUserID + "/followings?page=" + page;
        ...
        Volley.newRequestQueue(mContext).add(userFollowing);
    }
}
