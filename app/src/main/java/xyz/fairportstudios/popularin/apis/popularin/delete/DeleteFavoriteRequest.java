...
public class DeleteFavoriteRequest {
    ...
    public DeleteFavoriteRequest(Context context, int filmID) {
        mContext = context;
        mFilmID = filmID;
    }
    ...
    public void sendRequest(final Callback callback) {
        String requestURL = PopularinAPI.FILM + mFilmID + "/unfavorite";
        ...
        Volley.newRequestQueue(mContext).add(deleteFavorite);
    }
}
