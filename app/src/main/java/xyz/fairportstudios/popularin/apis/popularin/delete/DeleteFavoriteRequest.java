...
public class DeleteFavoriteRequest {
    ...
    public DeleteFavoriteRequest(Context context, Integer filmID) {
    ...
    public void sendRequest(final Callback callback) {
        String requestURL = PopularinAPI.FILM + filmID + "/unfavorite";
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    if (status == 404) {
                        ...
                        callback.onError(context.getString(R.string.delete_favorite_error));
                    }
