...
public class LikeReviewRequest {
    ...
    public void sendRequest(final APICallback callback) {
        ...
        JsonObjectRequest likeReviewRequest = new JsonObjectRequest(Request.Method.POST, requestURL, null, new Response.Listener<JSONObject>() {
            @Override
        ...
        Volley.newRequestQueue(context).add(likeReviewRequest);
    }
}
