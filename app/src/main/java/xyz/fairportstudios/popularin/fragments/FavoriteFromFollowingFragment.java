...
public class FavoriteFromFollowingFragment extends Fragment {
    ...
    private FavoriteFromFollowingRequest favoriteFromFollowingRequest;
    ...
    public FavoriteFromFollowingFragment(Integer filmID) {
        this.filmID = filmID;
    }
    ...
    private void getFavoriteFromFollowing(final Context context, Integer page) {
        ...
        favoriteFromFollowingRequest.sendRequest(page, new FavoriteFromFollowingRequest.Callback() {
            ...
            public void onNotFound() {
                ...
                textMessage.setText(R.string.empty_film_favorite_from_following);
            }
