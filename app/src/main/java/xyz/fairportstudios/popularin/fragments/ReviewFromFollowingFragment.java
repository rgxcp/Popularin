...
public class ReviewFromFollowingFragment extends Fragment implements FilmReviewAdapter.OnClickListener {
    ...
    public ReviewFromFollowingFragment(Integer filmID) {
        this.filmID = filmID;
    }
    ...
    public void onResume() {
        ...
        if (isResumeFirsTime) {
            ...
            mFilmReviewFromFollowingRequest = new FilmReviewFromFollowingRequest(mContext, filmID);
    ...
    private void getFilmReviewFromFollowing(Integer page, final Boolean refreshPage) {
