...
public class MutualFragment extends Fragment implements UserAdapter.OnClickListener {
    ...
    private UserMutualRequest mUserMutualRequest;

    // Variable constructor
    private int mUserID;

    public MutualFragment(int userID) {
        mUserID = userID;
    }
    ...
    public void onResume() {
        ...
        if (mIsResumeFirsTime) {
            ...
            mUserMutualRequest = new UserMutualRequest(mContext, mUserID);
    ...
    private void getUserMutual(int page, final boolean refreshPage) {
        mUserMutualRequest.sendRequest(page, new UserMutualRequest.Callback() {
            @Override
            ...
            public void onNotFound() {
                ...
                mTextMessage.setText(R.string.empty_mutual);
            }
