...
public class WatchlistFromFollowingFragment extends Fragment {
    ...
    private void getWatchlistFromFollowing() {
        WatchlistFromFollowingRequest watchlistFromFollowingRequest = new WatchlistFromFollowingRequest(context, filmID, userList, recyclerUser);
        String requestURL = watchlistFromFollowingRequest.getRequestURL(1);
