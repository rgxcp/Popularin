...
public class WatchlistFromFollowingFragment extends Fragment implements UserAdapter.OnClickListener {
    ...
    private WatchlistFromFollowingRequest mWatchlistFromFollowingRequest;

    // Variable constructor
    private int mFilmID;

    public WatchlistFromFollowingFragment(int filmID) {
        mFilmID = filmID;
    }
    ...
    public void onResume() {
        ...
        if (mIsResumeFirstTime) {
            ...
            mWatchlistFromFollowingRequest = new WatchlistFromFollowingRequest(mContext, mFilmID);
    ...
    private void getWatchlistFromFollowing(int page, final boolean refreshPage) {
        mWatchlistFromFollowingRequest.sendRequest(page, new WatchlistFromFollowingRequest.Callback() {
            @Override
            ...
            public void onNotFound() {
                ...
                mTextMessage.setText(R.string.empty_film_watchlist_from_following);
            }
