...
public class WatchlistFromFollowingFragment extends Fragment {
    ...
    private WatchlistFromFollowingRequest watchlistFromFollowingRequest;

    // Variable constructor
    private Integer filmID;

    public WatchlistFromFollowingFragment(Integer filmID) {
        this.filmID = filmID;
    }
    ...
    private void getWatchlistFromFollowing(final Context context, Integer page) {
        // Menghilangkan pesan setiap kali method dijalankan
        textMessage.setVisibility(View.GONE);

        watchlistFromFollowingRequest.sendRequest(page, new WatchlistFromFollowingRequest.Callback() {
            @Override
            ...
            public void onNotFound() {
                ...
                textMessage.setText(R.string.empty_film_watchlist_from_following);
            }
